...
#ifndef VERILATED_VSPATTENSIM_MULTIBANKRAM_24_H_
#define VERILATED_VSPATTENSIM_MULTIBANKRAM_24_H_  // guard

#include "verilated.h"
#include "verilated_threads.h"
class VSpAttenSim_StreamRAM_28;


class VSpAttenSim__Syms;

class alignas(VL_CACHE_LINE_BYTES) VSpAttenSim_MultiBankRAM_24 final : public VerilatedModule {
  public:
    // CELLS
    VSpAttenSim_StreamRAM_28* ram_insts_0;
    VSpAttenSim_StreamRAM_28* ram_insts_1;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__data_ram_insts_11_streamArbiter_158_io_output_combStage_ready;
        CData/*0:0*/ __PVT__data_ram_insts_11_streamArbiter_159_io_output_combStage_ready;
        CData/*0:0*/ __PVT__streamArbiter_158_io_output_valid;
        CData/*0:0*/ __PVT__data_ram_insts_11_streamArbiter_158_io_output_combStage_rValid;
        CData/*0:0*/ __PVT__data_ram_insts_11_streamArbiter_159_io_output_combStage_rValid;
        CData/*0:0*/ __PVT___zz_when_Stream_l369_1;
        CData/*0:0*/ __PVT___zz_when_Stream_l369_3;
        CData/*0:0*/ __PVT__data_ram_insts_11_streamArbiter_160_io_output_combStage_rValid;
        CData/*0:0*/ __PVT__data_ram_insts_11_streamArbiter_160_io_output_combStage_ready;
    ...
    struct {
        ...
        VlWide<4>/*127:0*/ __PVT__data_ram_insts_11_streamArbiter_160_io_output_combStage_rData_data;
    ...
    // CONSTRUCTORS
    VSpAttenSim_MultiBankRAM_24(VSpAttenSim__Syms* symsp, const char* v__name);
    ~VSpAttenSim_MultiBankRAM_24();
    VL_UNCOPYABLE(VSpAttenSim_MultiBankRAM_24);
