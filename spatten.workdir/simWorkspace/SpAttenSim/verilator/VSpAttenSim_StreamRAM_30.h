...
#ifndef VERILATED_VSPATTENSIM_STREAMRAM_30_H_
#define VERILATED_VSPATTENSIM_STREAMRAM_30_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VSpAttenSim_StreamRAM_30 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VSpAttenSim_StreamRAM_30(VSpAttenSim__Syms* symsp, const char* v__name);
    ~VSpAttenSim_StreamRAM_30();
    VL_UNCOPYABLE(VSpAttenSim_StreamRAM_30);
