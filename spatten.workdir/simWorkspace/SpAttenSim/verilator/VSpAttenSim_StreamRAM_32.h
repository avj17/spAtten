...
#ifndef VERILATED_VSPATTENSIM_STREAMRAM_32_H_
#define VERILATED_VSPATTENSIM_STREAMRAM_32_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VSpAttenSim_StreamRAM_32 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VSpAttenSim_StreamRAM_32(VSpAttenSim__Syms* symsp, const char* v__name);
    ~VSpAttenSim_StreamRAM_32();
    VL_UNCOPYABLE(VSpAttenSim_StreamRAM_32);
