...
#ifndef VERILATED_VSPATTENSIM_STREAMRAM_48_H_
#define VERILATED_VSPATTENSIM_STREAMRAM_48_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VSpAttenSim_StreamRAM_48 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VSpAttenSim_StreamRAM_48(VSpAttenSim__Syms* symsp, const char* v__name);
    ~VSpAttenSim_StreamRAM_48();
    VL_UNCOPYABLE(VSpAttenSim_StreamRAM_48);
