...
#ifndef VERILATED_VSPATTENSIM_MULTIBANKRAM_20_H_
#define VERILATED_VSPATTENSIM_MULTIBANKRAM_20_H_  // guard

#include "verilated.h"
#include "verilated_threads.h"
class VSpAttenSim_StreamRAM_36;


class VSpAttenSim__Syms;

class alignas(VL_CACHE_LINE_BYTES) VSpAttenSim_MultiBankRAM_20 final : public VerilatedModule {
  public:
    // CELLS
    VSpAttenSim_StreamRAM_36* ram_insts_0;
    VSpAttenSim_StreamRAM_36* ram_insts_1;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__data_ram_insts_7_streamArbiter_158_io_output_combStage_ready;
        CData/*0:0*/ __PVT__data_ram_insts_7_streamArbiter_159_io_output_combStage_ready;
        ...
        CData/*0:0*/ __PVT__data_ram_insts_7_streamArbiter_160_io_output_combStage_ready;
        CData/*0:0*/ __PVT__data_ram_insts_7_streamArbiter_160_io_output_combStage_rValid;
        ...
        CData/*0:0*/ __PVT__data_ram_insts_7_streamArbiter_158_io_output_combStage_rValid;
        CData/*0:0*/ __PVT__data_ram_insts_7_streamArbiter_159_io_output_combStage_rValid;
    ...
    struct {
        ...
        VlWide<4>/*127:0*/ __PVT__data_ram_insts_7_streamArbiter_160_io_output_combStage_rData_data;
    ...
    // CONSTRUCTORS
    VSpAttenSim_MultiBankRAM_20(VSpAttenSim__Syms* symsp, const char* v__name);
    ~VSpAttenSim_MultiBankRAM_20();
    VL_UNCOPYABLE(VSpAttenSim_MultiBankRAM_20);
