...
#ifndef VERILATED_VSPATTENSIM_STREAMRAM_44_H_
#define VERILATED_VSPATTENSIM_STREAMRAM_44_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VSpAttenSim_StreamRAM_44 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VSpAttenSim_StreamRAM_44(VSpAttenSim__Syms* symsp, const char* v__name);
    ~VSpAttenSim_StreamRAM_44();
    VL_UNCOPYABLE(VSpAttenSim_StreamRAM_44);
