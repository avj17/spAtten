...
#ifndef VERILATED_VSPATTENSIM_MULTIBANKRAM_15_H_
#define VERILATED_VSPATTENSIM_MULTIBANKRAM_15_H_  // guard

#include "verilated.h"
#include "verilated_threads.h"
class VSpAttenSim_StreamRAM_46;


class VSpAttenSim__Syms;

class alignas(VL_CACHE_LINE_BYTES) VSpAttenSim_MultiBankRAM_15 final : public VerilatedModule {
  public:
    // CELLS
    VSpAttenSim_StreamRAM_46* ram_insts_0;
    VSpAttenSim_StreamRAM_46* ram_insts_1;

    // DESIGN SPECIFIC STATE
    // Anonymous structures to workaround compiler member-count bugs
    struct {
        VlWide<4>/*127:0*/ __PVT__data_ram_insts_2_streamArbiter_160_io_output_combStage_rData_data;
        ...
        CData/*0:0*/ __PVT__data_ram_insts_2_streamArbiter_160_io_output_combStage_ready;
        CData/*0:0*/ __PVT___zz_when_Stream_l369_1;
        CData/*0:0*/ __PVT___zz_when_Stream_l369_3;
        CData/*0:0*/ __PVT__data_ram_insts_2_streamArbiter_158_io_output_combStage_rValid;
        CData/*0:0*/ __PVT__data_ram_insts_2_streamArbiter_159_io_output_combStage_rValid;
        CData/*0:0*/ __PVT__streamArbiter_158_io_chosen;
        CData/*0:0*/ __PVT__data_ram_insts_2_streamArbiter_158_io_output_combStage_ready;
        CData/*0:0*/ __PVT__data_ram_insts_2_streamArbiter_159_io_output_combStage_ready;
        ...
        CData/*0:0*/ __PVT__data_ram_insts_2_streamArbiter_160_io_output_combStage_rValid;
    ...
    // CONSTRUCTORS
    VSpAttenSim_MultiBankRAM_15(VSpAttenSim__Syms* symsp, const char* v__name);
    ~VSpAttenSim_MultiBankRAM_15();
    VL_UNCOPYABLE(VSpAttenSim_MultiBankRAM_15);
