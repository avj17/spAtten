...
#ifndef VERILATED_VSPATTENSIM_STREAMRAM_46_H_
#define VERILATED_VSPATTENSIM_STREAMRAM_46_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VSpAttenSim_StreamRAM_46 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VSpAttenSim_StreamRAM_46(VSpAttenSim__Syms* symsp, const char* v__name);
    ~VSpAttenSim_StreamRAM_46();
    VL_UNCOPYABLE(VSpAttenSim_StreamRAM_46);
